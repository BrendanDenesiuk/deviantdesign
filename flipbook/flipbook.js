...
for (let p = 0; p < numOfPages; p++) {
    if (p % 2 === 0) {
        ...
        if (p < preload) {
            frontContent.src = 'pages/WHAT IS BAD DESIGN v14 - Final for Class' + (p + 1) + '.png';
        }
        ...
        if (p < preload) {
            backContent.src = 'pages/WHAT IS BAD DESIGN v14 - Final for Class' + (p + 1) + '.png';
        }
...
function goNextPage() {
    if(currentLocation < numOfPapers) {
        ...
        if (2*currentLocation+preload < numOfPages) {
            ...
            page1.src = 'pages/WHAT IS BAD DESIGN v14 - Final for Class' + (2 * currentLocation + preload + 1) + '.png';
        }
        if (2*currentLocation+preload+1 < numOfPages){
            var page2 = pages[2*currentLocation+preload+1].firstElementChild
            page2.src = 'pages/WHAT IS BAD DESIGN v14 - Final for Class' + (2*currentLocation+preload+2)+'.png';
        }
